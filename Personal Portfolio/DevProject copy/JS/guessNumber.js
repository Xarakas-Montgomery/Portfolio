...
// Calculate the absolute difference between the guesses and the target number
   if (humanDifference <= computerDifference) {
        return true;  // Human wins if tied or closer
    } else {
        return false; // Computer wins if closer
    };
};
